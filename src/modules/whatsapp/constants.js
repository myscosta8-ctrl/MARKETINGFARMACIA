export const STATUS = [
  ...
  { value: 'enviada', label: 'Enviada', cor: 'text-amber-400 bg-amber-400/10' },
  { value: 'entregue', label: 'Entregue', cor: 'text-mint-400 bg-mint-400/10' },
  { value: 'lida', label: 'Lida', cor: 'text-mint-500 bg-mint-500/20' },
